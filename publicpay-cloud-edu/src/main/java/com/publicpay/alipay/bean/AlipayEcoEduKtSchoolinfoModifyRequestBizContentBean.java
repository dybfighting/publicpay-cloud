...
public class AlipayEcoEduKtSchoolinfoModifyRequestBizContentBean extends AlipayBizContentBean{
    @BeanToJson(Constant4AlipayEdu.SCHOOL_NAME)
    private String schoolName;//必选	256	学校名称
    @BeanToJson(Constant4AlipayEdu.SCHOOL_ICON)
    ...
    @BeanToJson(Constant4AlipayEdu.BANK_PARTNER_ID)
    private String bankPartnerId;//可选	32	与浙江网商交易见证平台有交互的ISV,由交易见证平台分配给合作方业务平台 签约唯一ID ，由网商分配给ISV的渠道参数
    @BeanToJson(Constant4AlipayEdu.WHITE_CHANNEL_CODE)

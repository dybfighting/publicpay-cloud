 ...
 * @version V1.0
 * @Package com.publicpay.edu.alipay.bean
 * @Description: 支付宝支付通知接口请求bean
 * @date 2018/7/20 下午3:48
 */
public class AlipayPayNotifyUrlRequestBean {
    @NotBlank(message = "notify_time不能为空")
    private String notify_time;//通知时间	Date	是	通知的发送时间。格式为yyyy-MM-dd HH:mm:ss
    ...
    private String buyer_logon_id;//买家支付宝账号	String(100)	否	买家支付宝账号	159﹡﹡﹡﹡﹡﹡20
    private String seller_id;//卖家支付宝用户号	String(30)	否	卖家支付宝用户号	2088101106499364
    private String seller_email;//卖家支付宝账号	String(100)	否	卖家支付宝账号	zhu﹡﹡﹡@alitest.com
